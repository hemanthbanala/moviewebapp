...
//         setRemainingDetails(stats.remainingDetails);
//       })
...
//                   <td className="py-2 px-4 border dark:border-gray-600">{b.user || '-'}</td>
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (err.message === 'Failed to fetch bookings' || err.message === 'Failed to fetch booking stats') {
  ...
  // ... search, filter, pagination logic remains unchanged ...
